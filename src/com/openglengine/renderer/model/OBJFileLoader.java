...
/**
 * Convenience class for loading OBJ files
 * 
 * @author Dominik
 *
 */
public class OBJFileLoader {
	...
	public static ModelData loadOBJ(String objFilePath) {
		FileReader isr = null;
		...
		double furthest = convertDataToArrays(vertices, textures, normals, verticesArray, texturesArray, normalsArray);
	...
	private static double convertDataToArrays(List<Vertex> vertices, List<Vector2f> textures, List<Vector3f> normals,
